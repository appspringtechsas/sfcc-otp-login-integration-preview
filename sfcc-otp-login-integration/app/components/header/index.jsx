...
import {
    ...
    useDisclosure,
    useMediaQuery
} from '@appspringtechsas/sfcc-otp-login-integration/app/components/shared/ui'
import {useCustomerType} from '@salesforce/commerce-sdk-react'

import {useCurrentBasket} from '@appspringtechsas/sfcc-otp-login-integration/app/hooks/use-current-basket'

import Link from '@appspringtechsas/sfcc-otp-login-integration/app/components/link'
import Search from '@appspringtechsas/sfcc-otp-login-integration/app/components/search'
import withRegistration from '@appspringtechsas/sfcc-otp-login-integration/app/components/with-registration'
import {
    AccountIcon,
    BrandLogo,
    BasketIcon,
    ...
    HeartIcon,
    SignoutIcon
} from '@appspringtechsas/sfcc-otp-login-integration/app/components/icons'

import {navLinks, messages} from '@appspringtechsas/sfcc-otp-login-integration/app/pages/account/constant'
import useNavigation from '@appspringtechsas/sfcc-otp-login-integration/app/hooks/use-navigation'
import LoadingSpinner from '@appspringtechsas/sfcc-otp-login-integration/app/components/loading-spinner'
import {isHydrated, noop} from '@appspringtechsas/sfcc-otp-login-integration/app/utils/utils'
import {TokenContext} from '@appspringtechsas/sfcc-otp-login-integration/app/contexts'
...
const Header = ({
    ...
    const {tokenContextLogout} = useContext(TokenContext)

    const onSignoutClick = async () => {
        setShowLoading(true)
        await tokenContextLogout()
        navigate('/login')
