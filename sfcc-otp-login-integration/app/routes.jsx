...
// Components
import {Skeleton} from '@appspringtechsas/sfcc-otp-login-integration/app/components/shared/ui'
import {configureRoutes} from '@appspringtechsas/sfcc-otp-login-integration/app/utils/routes-utils'

const fallback = <Skeleton height="75vh" width="100%" />

// Pages
const Home = loadable(() => import('./pages/home'), {fallback})
const PasswordlessLogin = loadable(() => import('./pages/passwordless-login'), {fallback})
